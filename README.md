...
[![GitHub License](https://img.shields.io/github/license/NTFSvolume/cdl)](https://github.com/Cyberdrop-DL/cyberdrop-dl//blob/main/LICENSE)
...
```powershell
uv tool install -p 3.12 cyberdrop-dl-patched --from "git+https://github.com/Cyberdrop-DL/cyberdrop-dl/"
```
