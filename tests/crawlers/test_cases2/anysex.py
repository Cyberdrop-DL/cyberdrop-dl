...
TEST_CASES = [
    ...
    {
        "url": "https://anysex.com/photos/156337/only-5-0-but-thick-and-curvy-in-all-the-right-places/",
        "results": [
            {
                "url": "re:https://photos.anysex.com/contents/albums/main/1920x9999/156000",
                "download_folder": "re:Only 50 but thick and curvy in all the right places! \\[album\\] \\(AnySex\\)",
        ...
        "results": [
            {
                ...
                "download_folder": "re:Natures big secret ️ \\[album\\] \\(AnySex\\)",
