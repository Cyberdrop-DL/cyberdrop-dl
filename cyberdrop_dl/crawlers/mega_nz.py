...
from cyberdrop_dl.crawlers.crawler import Crawler, DbPathBuiler, SupportedDomains, SupportedPaths, auto_task_id
...
class MegaNzCrawler(Crawler):
    ...
    create_db_path = staticmethod(DbPathBuiler.path_qs_frag)
